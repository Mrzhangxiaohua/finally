...
if __name__ == '__main__':
    ...
    print("\nRandom Repetitions...")
    print("wc->dslr:")
    calculate_adaption_test(EXP_FOLDER, N_REPETITIONS, NN, x_wc, y_wc, x_dslr, y_dslr)
    # print("wc->dslr:")
    ...
    # acc_dslram_SMD_D2_HAT, acc_dslram_DWMD, acc_dslram_DWMD1, acc_dslram_DWMD2, acc_dslram_DWMD3, acc_dslram_DWMD4, acc_dslram_DWMD5, acc_dslram_DWMD6, acc_dslram_DWMD7 = calculate_adaption(EXP_FOLDER, N_REPETITIONS, NN, x_dslr, y_dslr, x_am, y_am)
    #
    # print("wc->am:")
    # acc_wcam_None, acc_wcam_MMD, acc_wcam_MMatch, acc_wcam_SMD_D1, acc_wcam_SMD_D1_HAT, acc_wcam_SMD_D2, \
    # acc_wcam_SMD_D2_HAT, acc_wcam_DWMD, acc_wcam_DWMD1, acc_wcam_DWMD2, acc_wcam_DWMD3, acc_wcam_DWMD4, acc_wcam_DWMD5, acc_wcam_DWMD6, acc_wcam_DWMD7 = calculate_adaption(EXP_FOLDER, N_REPETITIONS, NN, x_wc, y_wc, x_am, y_am)
    #
    # print("==================================================================================")
    # print("am->wc")
    # calculate_print(acc_amwc_None, acc_amwc_MMD, acc_amwc_MMatch, acc_amwc_SMD_D1, acc_amwc_SMD_D1_HAT, acc_amwc_SMD_D2, acc_amwc_SMD_D2_HAT, acc_amwc_DWMD, acc_amwc_DWMD1, acc_amwc_DWMD2, acc_amwc_DWMD3, acc_amwc_DWMD4, acc_amwc_DWMD5, acc_amwc_DWMD6, acc_amwc_DWMD7)
    #
    # print("dslr->wc")
    # calculate_print(acc_dslrwc_None, acc_dslrwc_MMD, acc_dslrwc_MMatch, acc_dslrwc_SMD_D1, acc_dslrwc_SMD_D1_HAT, acc_dslrwc_SMD_D2, acc_dslrwc_SMD_D2_HAT, acc_dslrwc_DWMD, acc_dslrwc_DWMD1, acc_dslrwc_DWMD2, acc_dslrwc_DWMD3, acc_dslrwc_DWMD4, acc_dslrwc_DWMD5, acc_dslrwc_DWMD6, acc_dslrwc_DWMD7)
    #
    # print("wc->dslr")
    # calculate_print(acc_wcdslr_None, acc_wcdslr_MMD, acc_wcdslr_MMatch, acc_wcdslr_SMD_D1, acc_wcdslr_SMD_D1_HAT, acc_wcdslr_SMD_D2, acc_wcdslr_SMD_D2_HAT, acc_wcdslr_DWMD, acc_wcdslr_DWMD1, acc_wcdslr_DWMD2, acc_wcdslr_DWMD3, acc_wcdslr_DWMD4, acc_wcdslr_DWMD5, acc_wcdslr_DWMD6, acc_wcdslr_DWMD7)
    #
    # print("am->dslr")
    # calculate_print(acc_amdslr_None, acc_amdslr_MMD, acc_amdslr_MMatch, acc_amdslr_SMD_D1, acc_amdslr_SMD_D1_HAT, acc_amdslr_SMD_D2, acc_amdslr_SMD_D2_HAT, acc_amdslr_DWMD, acc_amdslr_DWMD1, acc_amdslr_DWMD2, acc_amdslr_DWMD3, acc_amdslr_DWMD4, acc_amdslr_DWMD5, acc_amdslr_DWMD6, acc_amdslr_DWMD7)
    #
    # print("dslr->am")
    # calculate_print(acc_dslram_None, acc_dslram_MMD, acc_dslram_MMatch, acc_dslram_SMD_D1, acc_dslram_SMD_D1_HAT, acc_dslram_SMD_D2, acc_dslram_SMD_D2_HAT, acc_dslram_DWMD, acc_dslram_DWMD1, acc_dslram_DWMD2, acc_dslram_DWMD3, acc_dslram_DWMD4, acc_dslram_DWMD5, acc_dslram_DWMD6, acc_dslram_DWMD7)
    #
    # print("wc->am")
    # calculate_print(acc_wcam_None, acc_wcam_MMD, acc_wcam_MMatch, acc_wcam_SMD_D1, acc_wcam_SMD_D1_HAT, acc_wcam_SMD_D2, acc_wcam_SMD_D2_HAT, acc_wcam_DWMD, acc_wcam_DWMD1, acc_wcam_DWMD2, acc_wcam_DWMD3, acc_wcam_DWMD4, acc_wcam_DWMD5, acc_wcam_DWMD6, acc_wcam_DWMD7)
    # print("==================================================================================")
