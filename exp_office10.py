...
from models.office10_mmatch import NN
from models.domain_regularizer import DomainRegularizer
from utils.office_utils import plot_activations
from utils.domain_adaption_result import calculate_adaption, calculate_print

from keras.preprocessing.image import ImageDataGenerator

EXP_FOLDER = 'experiments/office10/'
DATASET_FOLDER = 'utils/office10_dataset/'
...
if __name__ == '__main__':
    ...
    am_gen = datagen.flow_from_directory(DATASET_FOLDER + 'amazon',
                                         target_size=(S_IMAGE, S_IMAGE),
                                         batch_size=S_BATCH)
    dslr_gen = datagen.flow_from_directory(DATASET_FOLDER + 'dslr',
                                           target_size=(S_IMAGE, S_IMAGE),
                                           batch_size=S_BATCH)
    wc_gen = datagen.flow_from_directory(DATASET_FOLDER + 'webcam',
                                         target_size=(S_IMAGE, S_IMAGE),
                                         batch_size=S_BATCH)
    cal_gen = datagen.flow_from_directory(DATASET_FOLDER + 'caltech',
                                          target_size=(S_IMAGE, S_IMAGE),
                                          batch_size=S_BATCH)
    ...
    acc_wcdslr_SMD_D2_HAT, acc_wcdslr_DWMD, acc_wcdslr_DWMD1, acc_wcdslr_DWMD2, acc_wcdslr_DWMD3, acc_wcdslr_DWMD4, acc_wcdslr_DWMD5, acc_wcdslr_DWMD6, acc_wcdslr_DWMD7 = calculate_adaption(
    ...
    acc_dslrwc_SMD_D2_HAT, acc_dslrwc_DWMD, acc_dslrwc_DWMD1, acc_dslrwc_DWMD2, acc_dslrwc_DWMD3, acc_dslrwc_DWMD4, acc_dslrwc_DWMD5, acc_dslrwc_DWMD6, acc_dslrwc_DWMD7 = calculate_adaption(
    ...
    acc_amwc_SMD_D2_HAT, acc_amwc_DWMD, acc_amwc_DWMD1, acc_amwc_DWMD2, acc_amwc_DWMD3, acc_amwc_DWMD4, acc_amwc_DWMD5, acc_amwc_DWMD6, acc_amwc_DWMD7 = calculate_adaption(
    ...
    acc_amdslr_SMD_D2_HAT, acc_amdslr_DWMD, acc_amdslr_DWMD1, acc_amdslr_DWMD2, acc_amdslr_DWMD3, acc_amdslr_DWMD4, acc_amdslr_DWMD5, acc_amdslr_DWMD6, acc_amdslr_DWMD7 = calculate_adaption(
    ...
    acc_dslram_SMD_D2_HAT, acc_dslram_DWMD, acc_dslram_DWMD1, acc_dslram_DWMD2, acc_dslram_DWMD3, acc_dslram_DWMD4, acc_dslram_DWMD5, acc_dslram_DWMD6, acc_dslram_DWMD7 = calculate_adaption(
    ...
    acc_wcam_SMD_D2_HAT, acc_wcam_DWMD, acc_wcam_DWMD1, acc_wcam_DWMD2, acc_wcam_DWMD3, acc_wcam_DWMD4, acc_wcam_DWMD5, acc_wcam_DWMD6, acc_wcam_DWMD7 = calculate_adaption(
